...
quiver(xc,yc,5/uscale*Uocn_interp,5/uscale*Vocn_interp,'r','linewidth',2,'autoscale','off');
quiver(xc,yc,5/uscale*flipud(eularian_data.u),5/uscale*flipud(eularian_data.v),'g','linewidth',1,'autoscale','off');
% xx = 1; xx(1) =[1 2];
