...
if isempty(dir('./FloesOut/Floe')); disp('Creating folder: Floe'); mkdir('./FloesOut/Floe'); end
...
% while im_num<nSnapshots
    ...
    %Calculate forces and torques and integrate forward
